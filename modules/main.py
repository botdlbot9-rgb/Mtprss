...
async def account_login(bot: Client, m: Message):
    ...
    # ----- NEW: Token input for PW/ClassPlus -----
        ...
        for i in range(count - 1, len(links)):
            ...
            try:  
                ...
                if "drive" in url:
                    ...
                    # Purane helper function ke hisaab se call (url, cmd, name)
